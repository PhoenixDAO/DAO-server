...
export class UserService {
  ...
  findUserByNumioId = async req => {
    ...
    try {
      ...
      const findUserByNumioAddress = await this.userModel.find({
          numioAddress: req.body.address
      })
      // if(userExist.numioAddress != findUserByNumioAddress.numioAddress ||
      //   userExist.numioId != findUserByNumioAddress.numioId){
      //     console.log('Wrong address and Numio id')
      //     return false
      //   }
      // if (!userExist) {
